                            ...
                            <div class="form-group row no-gutters">
                                <div class="room-card col-4">
                                    ...
                                    <label for="carreta" class="card">
                                        <img class="card-img-top" src="assets/images/sala-carreta.webp" alt="Card image cap">
                                        <div class="card-body">
                                ...
                                <div class="room-card col-4">
                                    ...
                                    <label for="vuc" class="card">
                                        <img class="card-img-top" src="assets/images/sala-vuc.webp" alt="Card image cap">
                                        <div class="card-body">
                                ...
                                <div class="room-card col-4">
                                    ...
                                    <label for="toco" class="card">
                                        <img class="card-img-top" src="assets/images/sala-truck.webp" alt="Card image cap">
                                        <div class="card-body">
