...
// Escrever no arquivo
// fputcsv($resultado, array('Tratamento', 'Empresa', 'Cargo', 'E-mail Address'), ',', '"', '');
// fputcsv($resultado, array_map(function($value) { return str_replace('"', '', $value); }, $cabecalho), ',', ' ');

$cabecalho = array_map(function($value) { return str_replace('"', '', $value); }, $cabecalho);
fputcsv($resultado, $cabecalho, ',', ' ');

while($row_usuario = mysqli_fetch_assoc($result_usuarios)){
    // Escrever conteúdo
    // fputcsv($resultado, $row_usuario, ',', ' ');
    fputcsv($resultado, array_map(function($value) { return str_replace('"', '', $value); }, $row_usuario), ',', ' ');
}
