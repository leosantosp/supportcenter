                    ...
                    <div class="modal fade" id="modal<?php echo $dados['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-body">
                                ...
                                <strong>Ramal: </strong> <?php echo $dados['ramal'] ?><br>
                                <strong>E-mail:</strong> <?php echo $dados['email'] ?></p>
                                <br>
                                ...
                                <p> <strong>Descrição:</strong> <?php echo $descFinal ?> <br><br></p>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <button name="change-responsable" class="btn btn-secondary btn-responsavel" type="submit">Trocar responsável</button>
                                    </form>
