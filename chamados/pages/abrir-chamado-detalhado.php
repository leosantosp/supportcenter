        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mt-7">
                    ...
                    <p><?php 
                        if($dados['profile'] == 'ti'){
                            echo "Voltar para o chamado simplificado: <a href='abrir-chamado.php'>Clique aqui</a>";
                        }
                    ?></p>

                    

                    <form action="../php_action/create-call.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" name="btn-create" class="btn btn-primary">ABRIR CHAMADO</button>
                        </div>
                    </form>
                </div>
            </div>
