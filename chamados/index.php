...
<head>
    ...
    <title>Helpdesk VIPEX | Iniciar sessão</title>
...
<body id="login-page">
    <main class="row no-gutters">
        <section class="login-image col-md-7">
            <img class="img-fluid" src="assets/images/undraw_engineering_team_a7n2.svg" alt="">
        </section>

        <section id="login" class="login-form col-12 col-md-5">
            
            <div class="login-card">
                <h2 class="login-card-title">CHAMADOS T.I</h2>
                ...
                <form class="login-form-group" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <ul style="text-align: center; margin-top: 25px;">
                        <li><a style="color: white;" href="create-account.php">Criar uma conta</a></li>
                        <li><a style="color: white;" href="forgot-password.php">Esqueci a senha</a></li>
                    </ul>
                </form>
